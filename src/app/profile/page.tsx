...
const Page = ({ params }: { params: { user: userType } }) => {
  ...
  const save = () => {
    axios
      .put("/api/user/" + params.user.email + "/modification", {
  ...
  const changePic = async () => {
    ...
    data.set("file", updatedImage);
    data.set("user_uid", params.user.user_id);
    const res = await fetch("/api/upload_profile_picture", {
      method: "POST",
      body: data,
    });
    if (!res.ok) {
          ...
          <div className={styles.container}>
            <div className={styles.general}>
              <div className={styles.profile_picture}>
                ...
                {updatedImage ? (
                  <PlainButton
                    className={styles.clickable_button}
                    text="Save Img"
                    onClick={changePic}
                  />
                ) : (
                ...
                <div key={p.id} className={styles.container_historique}>
                  <div className={styles.container_row}>
                    ...
                    <div className={styles.container_buttonAvis}>
                      <a className={styles.button_market}>Donner mon avis</a>
                    </div>
                  </div>
                </div>
              );
